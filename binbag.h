...
DS_EXPORT size_t binbag_insert(binbag *bb, const char *str);
DS_EXPORT size_t binbag_insertn(binbag *bb, const char *str, int length);
...
DS_EXPORT size_t  binbag_insert_distinct(binbag* bb, const char* str);
